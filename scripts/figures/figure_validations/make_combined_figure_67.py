...
NETA=DATA+'/survey_s6_Ng1024'; NETB=DATA+'/survey_s7_Ng1024'; CACHE=DATA+'/pr2_two_net_67_cache.npz'
...
def blocks(ax,title):
    ...
    for f,l,cc in [(0.25,'net6',W),(0.75,'net7',X)]:
...
plt.savefig(FIG+'/combined_matrices_ratemapcorr_67.png',dpi=120,bbox_inches='tight')
plt.savefig(FIG+'/combined_matrices_ratemapcorr_67.pdf',bbox_inches='tight')
print('saved combined_matrices_ratemapcorr_67.png/pdf', flush=True); print('COMBINED_DONE', flush=True)
