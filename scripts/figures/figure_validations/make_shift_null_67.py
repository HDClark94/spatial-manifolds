...
plt.tight_layout(); plt.savefig(FIG+'/two_network_67_shiftnull.png',dpi=120,bbox_inches='tight'); plt.savefig(FIG+'/two_network_67_shiftnull.pdf',bbox_inches='tight')
print('saved two_network_67_shiftnull.png/pdf', flush=True); print('NULL_DONE', flush=True)
