...
plt.savefig(FIG+'/combined_matrices_ratemapcorr.png',dpi=120,bbox_inches='tight')
plt.savefig(FIG+'/combined_matrices_ratemapcorr.pdf',bbox_inches='tight')
print('saved combined_matrices_ratemapcorr.png/pdf', flush=True); print('COMBINED_DONE', flush=True)
