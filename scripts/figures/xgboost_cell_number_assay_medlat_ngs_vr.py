...
print(f"Running XGBoost Medial/Lateral NGS Assay (VR) for Mouse {mouse} Day {day} on cells {cell_start} to {cell_end-1}")
...
csv_path = f'{data_path}/xgboost_medlat_ngs_vr_M{mouse}_D{day}{suffix}.csv'
