...
pR2s_grids_comodular = np.zeros((49, len(n_neurons), len(grid_module_population_cluster_ids))); pR2s_grids_comodular[:,:,:] = np.nan
pR2s_grids_non_comodular = np.zeros((49, len(n_neurons), len(grid_non_module_population_cluster_ids))); pR2s_grids_non_comodular[:,:,:] = np.nan
