...
print(f"Running XGBoost Medial/Lateral NGS Assay (OF1) for Mouse {mouse} Day {day} on cells {cell_start} to {cell_end-1}")
...
csv_path = f'{data_path}/xgboost_medlat_ngs_of_M{mouse}_D{day}{suffix}.csv'
