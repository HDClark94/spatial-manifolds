...
for assay_mode in ["GC", "NGS"]:  # 'GC' for grid cells, 'NGS' for non grid spatial cells
    for mouse, days in mouse_days.items(): 
        for day in days:
            ...
            run_python_script(f"/exports/eddie/scratch/hclark3/spatial-manifolds/scripts/figures/xgboost_cell_number_assay_extra.py --mouse={mouse} --day={day} --assay_mode={assay_mode} --data_path={data_path}", username="hclark3", email="hclark3@ed.ac.uk", cores=32, job_name=job_name)
